...
const bootLines = [
  '> INITIALIZING JARVIS NEURAL CORE...',
        ...
        <div style={styles.bootContainer}>
          ...
          <div style={styles.terminal}>
            <div style={styles.terminalHeader}>
              ...
              <span style={styles.termTitle}>JARVIS_BOOT_SEQUENCE.exe</span>
            </div>
      ...
      {phase === 'logo' && (
        <div style={styles.logoContainer}>
          ...
          <div style={styles.logoText}>
            <div style={styles.logoJ}>J</div>
            <div style={styles.logoAR}>AR</div>
            <div style={styles.logoVIS}>VIS</div>
          </div>
...
const styles = {
  ...
  logoVIS: {
    ...
    lineHeight: 1,
    animation: 'text-reveal 0.4s ease-out 0.3s both',
  },
  logoTagline: {
    fontFamily: "'Share Tech Mono', monospace",
